    ...
    return (
      <div className="flex items-center justify-center h-screen bg-background p-6">
        <div className="text-center ">
          ...
          <h3 className="text-lg font-extralight mb-2">エディタを読み込み中</h3>
    ...
    return (
      <div className="flex items-center justify-center h-screen bg-background p-6">
        <div className="text-center text-primary">
          <h2 className="text-xl font-extralight mb-3">SakuEdit エディタ</h2>
          <p className="text-sm text-secondary font-extralight mb-4">
            現在の編集画面はデスクトップ向けのフルスクリーン体験を前提にしています。
            モバイル対応は順次進めています。
          </p>
          <p className="text-sm text-secondary font-extralight">
            モバイル対応の要望があれば、こちらから投票してください。{" "}
            <a
