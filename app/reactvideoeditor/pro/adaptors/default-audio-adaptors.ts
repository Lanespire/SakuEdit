 ...
 */
export const createStaticAudioAdaptor = (audioList: StandardAudio[], displayName: string = 'ストック音源'): SoundOverlayAdaptor => ({
  name: 'static-audio',
  displayName,
  description: '固定の音源コレクション',
  requiresAuth: false,
 ...
 */
export const defaultAudioAdaptor = createStaticAudioAdaptor(defaultAudioTracks, 'デフォルト音源');
