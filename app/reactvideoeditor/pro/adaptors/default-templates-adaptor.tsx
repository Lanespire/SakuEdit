...
const defaultTemplates = [
  {
    "id": "example-2",
    "name": "スポーツ",
    "description": "React Video Editorで作成されたカスタムテンプレート",
  ...
  },
  {
    id: "template-7",
    name: "ハンドテンプレート",
    description: "テキストアニメーションの実験用テンプレートです。",
...
export const createStaticTemplateAdaptor = (
  displayName: string = "デフォルトテンプレート"
...
export const defaultTemplateAdaptor =
  createStaticTemplateAdaptor("デフォルトテンプレート");
